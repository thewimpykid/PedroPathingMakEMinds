...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = -0.00295;//2000 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = 0.00296;//2000 * 1.37795 * 2 * Math.PI * 0.5018874659;
    public static double TURN_TICKS_TO_RADIANS = -0.0034;//2000 * 1.37795 * 2 * Math.PI * 0.5;
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(-1, 6, 0); //6, 4
        rightEncoderPose = new Pose(-1, -6, 0); //-6, 4
        strafeEncoderPose = new Pose(-1, -2, Math.toRadians(90)); //-1,0
        ...
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "frontRight"));

        // TODO: reverse any encoders necessary
        leftEncoder.setDirection(Encoder.FORWARD); // idk what this does
