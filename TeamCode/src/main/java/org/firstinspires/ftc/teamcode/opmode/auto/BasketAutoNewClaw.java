...
//                arm.setPosition(-3750, 1.0); // this is the old arm position
                arm.setPosition(-2400, 0.7);

                setPathState(1);
                break;
            case 1:
                if (arm.sendPosition() < -1000) {
                    slide.setPosition(-2900, 1.0);
                    setPathState(2);
                }
                break;
...
//                arm.setPosition(-3750, 1.0); // this is the old arm position
                ...
                break;
            case 7:
                if (arm.sendPosition() < -1000 && !follower.isBusy()) {
                    slide.setPosition(-2900, 1.0);
                    setPathState(8);
                }
                break;
